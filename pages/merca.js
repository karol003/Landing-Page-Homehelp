...
const Merca = ({ Component, pageProps }) => {
      ...
      `}</style>
        ...
        <nav className={styles.menupc}>
          ...
          <ul>
            ...
            <li><Link className={styles.am} href="/constru">Construção</Link></li>
        ...
        <div className={`${styles.menumobile} ${menuOpen ? styles.open : ''}`}>
          <ul>
            ...
            <li className="nav-item"><Link className={styles.aaa} href="/constru">Construção</Link></li>
          </ul>
        </div>
      </header>
      <main>
